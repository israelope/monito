...
// Import data from your new constants file
import { petsData, productsData, knowledgeData, sellerLogos } from '../../Constants/Index';


// --- Sub-Components (Header, Hero, PetCard, etc. remain the same as before) ---
    ...
    <footer className="bg-[#FCEED5] pt-16">
        <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center py-6 text-center">
                <p className="text-gray-600 text-sm">&copy; 2022 Monito. All rights reserved.</p>
